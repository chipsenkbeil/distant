...
///
/// When built from a git checkout, produces `X.Y.Z (abc1234def 2026-03-03) [docker, host, ssh]`.
/// A dirty working tree appends `+` to the hash: `X.Y.Z (abc1234def+ 2026-03-03) [docker, host, ssh]`.
/// When git is unavailable (tarball builds), falls back to `X.Y.Z [docker, host, ssh]`.
